...
export function CircleCheckSvg() {
    return (
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M23 13L15.4375 21L12 17.3636" stroke="#5758D6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
};

export function CircleCheckSvgTwo() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="8" viewBox="0 0 10 8" fill="none">
        <path d="M9 1L3.5 6.5L1 4" stroke="#262B35" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
     </svg>
    );
};