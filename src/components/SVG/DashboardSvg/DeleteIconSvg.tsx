...
export default function DeleteIconSvg() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            ...
            <path d="M13 3.09998H1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
            ...
            <path d="M5.33594 9.70007L5.33594 6.10007" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
            <path d="M8.66406 9.69998L8.66406 6.09998" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
        </svg>
    );
}
