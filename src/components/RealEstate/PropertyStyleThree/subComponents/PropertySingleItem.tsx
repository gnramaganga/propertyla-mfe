...
export default function PropertySingleItem({
  item,
}: {
  ...
  // Handle adding a product to the compare list
  ...
  return (
    <div className="tp-rent-item p-relative">
      <div className="tp-rent-thumb p-relative">
        <Link href={`/property-details-3/${item.id}`}>
      ...
      <div className="tp-rent-content">
        <h4 className="tp-rent-title pb-20">
          <Link className="textline" href={`/property-details-3/${item.id}`}>
            {item.title}
          </Link>
        </h4>
        ...
        <div className="tp-rent-4-btn">
          <Link
            ...
            href={`/property-details-3/${item.id}`}
          >
            View Details
          </Link>
        </div>
