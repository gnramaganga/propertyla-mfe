...
export default function AboutTestimonial() {
    return (
        <section className="tp-testimonial-5-ptb pt-130 pb-140" style={{ backgroundColor: "#F0F4FD" }}>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-12">
                        <div className="tp-testimonial-about-btn text-center">
                            <span>Let’s make something great work together. <Link href="/property-details-1">Got a project in mind?</Link></span>
                        </div>
                    </div>
                </div>
            </div>
