...
const features = [
    ...
    { id: 2, title: "Sell a property", icon: featureIcon2, link: "/property-details-1", delay: "0.7s" },
    { id: 3, title: "Rent a property", icon: featureIcon3, link: "/property-details-1", delay: "0.3s" },
];
